...
# SECRET_KEY = os.getenv("MRC_JWT_SECRET_KEY", "changeme-super-secret-key")
# ALGORITHM = "HS256"
...
# ✅ SECURITY FIX: No default value - forces explicit configuration
...
# ✅ SECURITY FIX: Reject weak/default secrets at startup
