...
# This file defines a **unified way for your system to talk to different AI models (LLMs)**. It:
# * Wraps messages and tool calls in a common format
# * Supports multiple providers (OpenAI, Anthropic, Ollama)
# * Converts between each provider’s message/tool format
# * Lets your system try multiple providers automatically if one fails

# **In short:** it’s a “universal adapter” for sending prompts and receiving AI responses.
